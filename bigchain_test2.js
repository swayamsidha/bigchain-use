...
const API_PATH = 'http://10.42.0.1:32809/api/v1/'
/*{
  app_id: 'bfc4ddd3',
...
exports.createAndTransfer = function(assetdata, metadata){
  ...
  const txid = txCreateAliceSimpleSigned.id

  // Send the transaction off to BigchainDB
  const conn = new driver.Connection(API_PATH)
  console.log("connected to bigchain server")
